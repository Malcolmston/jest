...
func TestToBeTruthyFalsy(t *testing.T) {
...
func TestToContainEqual(t *testing.T) {
...
func TestToBeOneOf(t *testing.T) {
...
func TestReturnMatchers(t *testing.T) {
	m := NewMock("f")
...
func TestReturnTimesWithPanic(t *testing.T) {
	m := NewMock("boom")
...
func TestJestAliases(t *testing.T) {
	m := NewMock("f")
	m.Return(42)
	m.Call(1, 2)

...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/jest', initials: 'je', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/jest</span> — Jest-style fluent assertions and mocking, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of Jest for Go</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/jest" footer={footer}>
